from polus.models import split_bert_model, split_bert_model_from_checkpoint
...
def test_validate_output_of_split_bert_checkpoint():
    ...
    pre_model, post_model = split_bert_model_from_checkpoint("bert-base-uncased", -2, init_models=False)
